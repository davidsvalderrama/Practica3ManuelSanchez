...
class NuevaImagen extends StatefulWidget {
  NuevaImagen({Key key}) : super(key: key);

  @override
  _NuevaImagenState createState() => _NuevaImagenState();
}

class _NuevaImagenState extends State<NuevaImagen> {
  @override
